            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        className="fixed inset-0 md:inset-auto md:top-1/2 md:left-1/2 md:-translate-x-1/2 md:-translate-y-1/2 w-[95%] h-[90%] md:w-full md:max-w-3xl md:h-auto z-[101] p-0 md:p-0 m-auto"
                    >
                        <div className="bg-neutral-900 border border-white/10 rounded-2xl overflow-hidden shadow-2xl h-full md:max-h-[85vh] flex flex-col">
                            <div className="relative w-full aspect-[12/10] md:aspect-[2/1] bg-neutral-800 shrink-0">
